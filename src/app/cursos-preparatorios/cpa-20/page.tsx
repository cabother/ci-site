...
export default function CPA20Page() {
  const modulos = [
    'Fundos de Investimento Avançados',
    'Previdência Privada',
  ...
  const beneficios = [
    ...
    'Mais de 1.200 questões de simulados',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <div className="inline-flex items-center bg-primary-100 text-primary-800 px-4 py-2 rounded-full text-sm font-medium">
              ...
              Certificação para Produtos Complexos
            </div>
          </div>
            ...
            <div>
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <p className="text-gray-600 mb-6">
                  A CPA-20 é exigida para atuar com produtos de investimento mais complexos. Esta certificação é essencial para profissionais que trabalham com fundos de investimento, previdência privada e outros produtos estruturados.
                </p>
                <p className="text-gray-600 mb-6">
            ...
            <div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="text-gray-500">ou 12x de R$ 36,58 sem juros</div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">1.200+ questões</span>
                  </div>
                  <div className="flex items-center">
