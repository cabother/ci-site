...
export default function CEAPage() {
  ...
  const beneficios = [
    ...
    'Mais de 1.300 questões de simulados',
            ...
            <div>
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <p className="text-gray-600 mb-6">
                  A CEA é o passo que separa o profissional comum do especialista em investimentos. Esta certificação é voltada para profissionais que desejam se especializar em análise de investimentos e gestão de carteiras.
                </p>
                <p className="text-gray-600 mb-6">
            ...
            <div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <div className="text-center mb-6">
                  <div className="text-3xl font-bold text-primary-600 mb-2">R$ 749,00</div>
                  <div className="text-gray-500">ou 12x de R$ 62,42 sem juros</div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">8 meses de acesso</span>
                  </div>
                  <div className="flex items-center">
                    <BookOpen className="h-5 w-5 text-primary-600 mr-3" />
                    <span className="text-gray-700">1.300+ questões</span>
                  </div>
                  <div className="flex items-center">
