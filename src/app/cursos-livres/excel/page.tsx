        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
              Domine o Excel com funções avançadas e automação para o mercado financeiro
            </p>
            ...
            <div>
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <p className="text-gray-600 mb-6">
                  Aprenda Excel do básico ao avançado com foco no mercado financeiro. Inclui funções complexas, macros, dashboards e automação de processos.
                </p>
                <p className="text-gray-600 mb-6">
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">Planilhas práticas</span>
                  </div>
                  <div className="flex items-center">
