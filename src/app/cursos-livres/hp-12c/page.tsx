...
import { ArrowLeft, Clock, BookOpen, Users, Award, CheckCircle, Calculator } from 'lucide-react'
...
export default function HP12CPage() {
  ...
  const beneficios = [
    'Apostila completa com exercícios práticos',
    'Simulador online da HP-12C',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
              Matemática Financeira com Calculadora HP-12C
            </p>
            ...
            <div>
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <p className="text-gray-600 mb-6">
                  Domine a calculadora HP-12C e os cálculos financeiros essenciais. Aprenda desde operações básicas até cálculos complexos de investimentos.
                </p>
                <p className="text-gray-600 mb-6">
            ...
            <div>
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
                ...
                <div className="text-center mb-6">
                  <div className="text-3xl font-bold text-primary-600 mb-2">R$ 177,00</div>
                  <div className="text-gray-500">ou 12x de R$ 14,75 sem juros</div>
